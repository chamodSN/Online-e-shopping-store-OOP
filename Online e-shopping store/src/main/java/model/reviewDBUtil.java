...
public class reviewDBUtil {
	...
	public static List<review> getReviews(String productId) {
	...
	public static boolean updateReview(String revid, String productId, String userId, String rating, String review,
			String date) {
	...
	public static List<review> getReviewDetails() {
